...
router.post('/', async (req, res) => {
  try {
    ...
    const exists = await sql.query(`SELECT "CouponID" FROM "coupons" WHERE "CouponCode" = $1`, [/* add params here */]);
...
router.put('/:CouponID', async (req, res) => {
  try {
    ...
    const check = await sql.query(`SELECT * FROM "coupons" WHERE "CouponID" = $1`, [/* add params here */]);
...
router.delete('/:CouponID', async (req, res) => {
  try {
    ...
    await sql.query(`DELETE FROM "coupons" WHERE "CouponID" = $1`, [/* add params here */]);
